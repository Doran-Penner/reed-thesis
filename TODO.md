...
## current outline
The 1.a number is planned number of days for the MVP.
...
4. my work: improvements & flexibility with prolly trees (maybe each is its own chapter)
...
- prolly tree
    ...
    - content-defined chunking _(2)_
    - what the prolly tree actually is _(1)_
    - discussion vs mst and others _(1)_
- prolly tree properties
    a. proofs about read/write runtimes, etc _(1 for MVP)_
    - prolly tree as a crdt (incl. when the values are crdts) _(3)_
        ...
        - ...?
    - what other existing properties do we wanna talk about? how/when should I meld into my own contributions? _(?)_
- my work: improvements & flexibility with prolly trees (maybe each is its own chapter)
    a. dynamo-like _(not in MVP)_
    - send data in op-like way _(not in MVP)_
    - range tree for array; other data structures (we get JSON) _(not in MVP)_
    - improve the cdc system (stuff that Dolt did) _(not in MVP)_
    - and so on! _(not in MVP)_
