...
Currently iterating through MST explanation.
...
For our purposes, B-trees are search trees that are self-balancing and efficient block sizes. A Merkle Search Tree is like a B-tree with some additional measures for comparing trees.
