...
Currently iterating through prolly explanation.

![Dependencies for explaining the prolly tree: content-defined chunking, Merkle trees, and B-trees are the first level.](../figures/tmp-mst-explain-graph.jpg)
...
TODO re-do all this stuff (using "Prolly Tree")
