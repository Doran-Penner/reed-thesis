...
- nodes can exhibit faulty or actively malicious behavior that messes up communication;
...
- communication between nodes is inherently prone to failure, meaning that it cannot be completely trusted,
- and there is always the possibility that a node doesn't have the most up-to-date information.
