...
### general intro, background, etc

<!-- Formatting: do I want this to be just under the 2nd-level dist. sys. heading, or a dedicated 3rd-level like right now? For now I will keep it very deeply nested, but for readability later I may un-nest some parts. -->

Textbook is @distsys-textbook. A distributed system is one where multiple devices work together to provide some combined program or service (instead of one machine doing it all). Simple distributed example is grapevine [@grapevine].
