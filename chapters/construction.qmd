...
<!-- TODO change this section a bit. Maybe drop the hash table example. Maybe just explain it as a key-value dictionary. -->
...
In a Prolly tree, content-defined chunking usually prevents the chunk-shift problem when data is inserted or changed, no matter the position.
